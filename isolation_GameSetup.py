# Mark Trinquero
# Setup for isolation gameplay and helper functions
...
class Board:
    ...
    def __get_moves__(self, move):
        ...
        # tracking of valid gameplay moves
        valid_moves = []
    ...
    def print_board(self):
        ...
        for i in range(0, len(b)):
            ...
            out += '\n\r'
        return out
    # define gameplay params here, note can extend time limit as needed
    def play_isolation(self, time_limit=500000000, debug=True):
